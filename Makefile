...
OFILES = gba.o font.o draw.o logic.o main.o images/garbage.o startimage.o ingamebackground.o frog.o bigtruck.o purplecar.o racecar.o bulldozer.o yellowcar.o gameover.o winscreen.o
################################################################################
